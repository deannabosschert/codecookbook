...
toScss('color', 'variables', getData('design-tokens')) // fetch data from design-tokens.json, which is generated by figma
toScss('font', 'selectors', getData('design-tokens'))
toScss('spacing', 'list', getData('variables')) // fetch data from file i've samengesteld myself for now
